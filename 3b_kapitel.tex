...
Ein Akteur in der Schaffung globaler Standards für Umwelt- und Sozialstandards im Bergbau ist die IRMA.

Die IRMA ist jedoch weder global noch sektorübergreifend breit vertreten; zwar sind alle europäischen Automobilkonzerne und auch US-amerikanische Hersteller Mitglieder der IRMA, jedoch ist die IRMA insbesondere in rohstoffabbauenden Ländern nicht präsent. Die Standards der IRMA richten sich in erster Linie an die Anlagen selbst und nicht etwa in der gesamten Lieferkette oder den Betreiber als Gesamtes, sind also nicht mit Due-Dilligence-Standards gleichzusetzen.


Auch die Mitgliederstruktur des Intergouvernmnetal Forum on Mining, Minerals, Metals and Sustainable Development (IGF) mit seinem Mining Policy Framework (MPF). Das MPF definiert zwar \textit{good practices} für umwelt‑, sozial‑ und wirtschaftspolitische Regierungsführung im Bergbausektor, es handelt sich jedoch um ein ausschließlich freiwilliges Rahmenwerk ohne Mechaismen zur Durchsetzung oder Sanktionierung. Dies bedeutet, dass Umsetzungsdefizite folglos bleiben und eine Mitgliedschaft noch keine Befolgung garantiert. Zwar führt der IGF MPF-Assessments durch, um entsprechende Lücken auch in der nationalen Bergbaugesetzgebung zu identifizieren und stellt diese in entsprechenden Länderberichten auch fest -- jedoch handelt es sich auch hier schlicht um Empfehlungen, die zusammen mit den eher allgemeinen Empfehlungen des Frameworks keine Bindungswirkung entfalten. Die Wirksamkeit des MPF hängt somit fast vollständig von nationalen politischen Strukturen ab, nicht vom MPF selbst. Auch enthält das MPF keine konkreten Mechanismen, z.B. zur Überwachung von Menschenrechtsverletzungen oder eindeutige Grenzwerte für umweltbezogene Standards. Zudem richtet sich das MPF primär an Regierungen und nicht an UNternehmen, sodass Themen wie Lieferketten oder Due Dilligence keine Berücksichtigung finden.

Diese unverbindlichen Standards werden oftmals mit einer Zertifizierung der EInhaltung der Standards verknüpft, dessen Überwachung externe Auditoren übernehmen -- jedoch wurde bereits darauf hingewiesen, dass 

Auch durch die Schaffung weiterer, abweichender Standards insbesondere auch durch staatliche Akteure, wird die Vereinheitlichung von Standards in der Rohstoffverwaltung weiter erschwert.

So fehlt es weiter an verbindlichen globalen Bergbau-Minimalstandards

Viele Herausforderungen moderner Rohstoffverwaltung sind zudem transnational, insbesondere hinsichtlich Umwelt- und Klimastandards
...
Hinzu kommt, dass in einer Vielzahl an rohstoffabbauenden Ländern Probleme wie Governance-Schwächen, sog. \glqq Elite Capture\grqq sowie unklare oder fragmentierte Zuständigkeiten und Verwaltung die Durchsetzungs- und Kontrollmöglichkeiten in erheblichem Maße ein schränken.\autocite{International Copper Study Group, Regulatory Survey 2026, S. 51.}

\section{Rohstoffe und Umwelt- sowie Klimaschutz}
...
Die Notwendigkeit zur Transformation ergibt sich in erster Linie aus klimabezogenen Überlegungen, jedoch interferiert der Klimawandel auch mit bergbaulichen Maßnahmen, die eigentlich zur Abschwächung ebendessen beitragen sollen, z.B. durch Extremwetterereignisse.\autocite{Climate Change Impacts on Mining Value Chain: A Systematic Literature Review, Ali Nouri Qarahasanlou}
...
Auch regulatorische, nicht direkt auf Rohstoffe bezogene Hürden erschweren die Ansieldung einer Rohstoffgewinnung und -verarbeitung in der EU: So erschweren geplante Regulierungen zu Chemikalien die Entwicklung eines solchen Industriezweigs in der EU nach Angaben der Industrie.\autocite{https://www.ft.com/content/bbc289b9-7818-4e16-b794-a52a7132f3df?desktop=true&segmentId=d8d3e364-5197-20eb-17cf-2437841d178a#myft:notification:instant-email:content}
...
Eine einschlägige Anwendung des Begriffs Nachhaltigkeit im Bereich der Rohstoffe gestaltet sich weiterhin schwierig, nicht zuletzt durch die Vielzahl an ESG-Auflagen und der potentiellen Überschneidung verschiedener Politikbereiche, deren Standards für Rohstoffe gelten bzw. gelten könnten.

Insbesondere die Diversität hinsichtlich der Regulierung im Nachhaltigkeitsbereich ist anzusprechen, divergieren die Ansätze hier von unverbindlichen Maßnahmen über reine Transparenzrichtlinien hin zu extensiven Berichtspflichten und kodifizierten Regelungen, sodass insgesamt eine Abweichung hinsichtlich des Umfangs, aber auch des angemessenen Vergleichs der einzelnen Regelwerke zu attestieren ist.

Darauf folgt die Herausforderung der Durchsetzung: auch hier weichen die unterschiedlichen Ansätze voneinander ab, und die Diskussion um die Entwaldungsrichtlinie hat gezeigt, dass eine Rückverfolgbarkeit einzelner Wertschöpfungs- und Lieferkettenschritte durchaus auf Widerstand trifft -- nicht etwa wegen Mehraufand, sondern aus Gründen der praktischen Anwendbarkeit und Verhältnismäßigkeit.

Insgesamt ist daher auch der Nachhaltigkeitsbezug im aktuellen Rohstoffrechtsrahmen als lückenhaft und teils unklar einzustufen, sodass für eine effektive Rohstoffverwaltung die Schaffung von einheitlichen, nachprüfbaren und durchsetzbaren Regeln unausweichlich scheint.

Zudem steht die Union vor dem Problem der Legitimität, denn nicht nur die rein technische Umsetzung ist hier von Bedeutung, damit der Anspruch insbesondere im globalen Vergleich 
...
Das zunehmende Selbstbewusstsein rohstoffabbauender Staaten führt darüber hinaus potentiell zu einem Legitimitätsproblem, d.h. dass die Gesamtheit an Bedingungen und Auflagen bzw. Regularien der Union schlichtweg keine Relevanz mehr besitzt, unsbesondere im direkten Vergleich mit anderen Partnern, die in Konkurrenz zu Union stehen. Daher ist insbesondere bei der weiteren Ausgestaltung der externen Dimension der Rohstoffverwaltung darauf zu achten, dass über Transparenz und Beteiligung Legitimation geschaffen wird und einen möglicherweise \glqq ausbeutenden\grqq Charakter verhindert, sodass Spanunngen vermieden werden und nicht erneut Abhängigkeitspotentiale (auf welcher Seite auch immer) entstehen oder Bemühungen durch einen Kollaps des gemeinsamen Frameworks ad absurdum geführt werden.
...
Sog. Manganknollen enthalten hierbei insbesondere die für die Produktion von EV-Batterien benötigten Rohstoffe
...
Norwegen stimmte im Parlament 2024 zwar für den Abbau, jedoch ist die Lizenzvergabe zunächst bis 2029 ausgesetzt.\autocite{https://www.zeit.de/politik/ausland/2025-12/norwegen-tiefseebergbau-seltene-erden-umweltschutz-gxe}

Aktuell geht es stattdessen vielmehr um die Frage, ob, unter welchen Bedingungen und wann Tiefseebergbau erstmals real umgesetzt wird\autocite{NuR (2023) 45: 169–175}. Zudem lassen sich die Auswirkung des Tiefseebergbaus auf die bisherige Rohstoffbasis nur begrenzt abschätzen, auch weil ein Großteil der Rohstoffe dem internationalen Recht und damit der Regelung durch die IMB unterstehen und auch technische Modliäten noch nicht vollends finalisiert sind.\autocite{Commodity Top News 40, S. 9} Im Bereich der AWZen der EU-Mitgliedsstaaten liegen nur sehr geringe Potentiale zum Tiefseebergbau aufgrund der vorhandenen Rohstoffe vor,\autocites{An Overview of Seabed Mining Including the Current State of Development, Environmental Impacts, and Knowledge Gaps, Miller et al. 2018 }[ebenso]{Deep-ocean mineral deposits as a source of critical metals for high- and green-technology applications: Comparison with land-based resources, Hein et al. 2013} sodass hier kein besonderer Politikfokus zu erwarten ist.


Ein Mining Code existiert weiterhin nicht, die International Seabed Authority arbeitet weiter an einem solchen, obwohl ein Regelwerk bis 2025 entwickelt werden sollte.\autocite{https://www.zeit.de/wissen/umwelt/2023-07/tiefseebergbau-internationale-meeresbodenbehoerde-sitzung-manganknollen} Auch sind Fragen hinsichtlich der Umweltverträglichkeit

Mehrere deutsche Automobilhersteller stehen dem Tiefseebergbau zudem kritisch gegegnüber. Auch Volvo erklärte seine Ablehnung gegenüber dem Tiefseebergbau.\autocite{https://www.volvocars-news.ch/dna-of-volvo/volvo-cars-lehnt-tiefseebergbau-ab/}

Aufgrund der aktuell nachrangigeren Bedeutung sowie offensichtlicher politischer Hürden scheint es angebracht, den Tiefseebergbau im Rahmen der Rohstoffverwaltung vorest nicht weiter zu betrachten. Grundsätzlich käme er infrage--aufgrund der mangelnden Vorkommen jedoch auch vermutlich vornehmlich im Bereich von Rohstoffpartnerschaften und -abkommen. Zudem erscheint eine Umsetzung in den nächsten Jahren unrealistisch, sodass kein Beitrag zur Sicherung der Rohstoffversorgung durch den Tiefseebergbau zu erwarten ist, auch aufgrund des im Vergleich mit anderen Rohstofferschließungsstrategien unentwickelten Status mit offenen Fragen hinsichtlich der Regulierung und Umweltauswirkungen.\autocite{https://www.wri.org/insights/deep-sea-mining-explained} Somit könnte sich der Tiefseebergbau auch zu einer der bestimmenden regulatorischen Fragen des Jahrzehnts entwickeln.\autocite{https://media.licdn.com/dms/document/media/v2/D4D1FAQEAIHCav-AneQ/feedshare-document-url-metadata-scrapper-pdf/B4DZxX1ZLwIoA4-/0/1771000145057?e=1771837200&v=beta&t=MitIN7QLZoAnNvyYxv_Ut-RXUJucvGrtLlfxS0L2FQg, S, 11}
...
Die Unternehmen geraten damit zunehmend in eine Dilemmasituation: Entsprechende Standards werden zwar gefordert und auch umgesetzt, werden jedoch durch politische Grenzen eingeschränkt, wie besonders in der sich ausweitenden Verflechtung und Verrechtlichung von Sorgfaltspflichten auf nationaler bzw. europäischer Ebene zeigt und entsprechende Konfliktsituationen entstehen.

\subsection{Verfahrensautonomie der EU-Mitgliedsstaaten}
Grundsätzlich obliegt der Vollzug einzelner Titel den Mitgliedsstaaten, mit der Einschränkung durch entsprechende Vorgaben der Union, sodass die Verfahrensautonomie der Mitgliedsstaaten gegenüber der  Europäisierung der nationalen (Verwaltungs-)Rechtssysteme als eine \glqq ungeklärte Kardinalsfrage\grqq \autocite{Ludiwgs, NVwZ 2018, 1417} betrachtet werden kann
...
Die zunehmende Politisierung des Rohstoffrechts und der Rohstoffthematik im Allgemeinen ist insbesondere in der letzten Phase des Aufmerksamkeitsschwungs deutlich geworden. 

Die globale Verfügbarkeit von Rohstoffen wird in erheblichem Maße durch die Geopolitik beeinflusst.\autocite{bibid}

Akteure der staatlichen Politik übernehmen hierbei eine aktivere Rolle bei der Sicherung von Rohstoffquellen, angetrieben von der strategischen und wirtschaftlichen Bedeutung dieser Mineralien.\footnote{Future Minerals Barometer Report 2025, S. 36} Die genaue Ausgestaltung nimmt hierbei unterschiedliches Ausmaß an: Von reinen Strategiepapieren über den EU CRMA oder aber die Rohstoffzielsetzungen Japans und den USA, wobei letztere insbesondere die strategische Relevanz und die Erforderlichkeit der Finanzierung erkannt haben.
...
Zahlreiche Länder haben in der Vergangenheit Schritte hin zu einer Regionalisierung und damit auch Politisierung des Rohstoffbereichs unternommen, sodass lokale Lieferketten bevorzugt werden und die allgemeine Abhängigkeit vom globalen Handel verringert wird. Dieser Trend wird durch geopolitische Spannungen, Handelskriege und der Notwendigkeit des Resilienzaufbaus in der Wirtschaft in Verbindung mit der starken regionalen Konzentration von Rohstoffen weiter verstärkt.

Die Konzentration hat in Teilen zu disruptiven Maßnahmen geführt, um die Abhängigkeit zu verringern und somit auch die jeweilige (nationale) Wirtschaft zu schützen -- der CRMA kann als bestes Beispiel hierfür herangezogen werden, zielt er doch auf die Sicherung von Rohstofflieferketten und die Reduzierung der externen Abhängigkeit ab.

China beschränkt zunehmend den Export bestimmter Mineralien (s.u.), während zunehmende Regionalisierung zu fragmentierenden Märkten führen kann, sodass Selbstversorgung oder exklusive Allianzen über globaler Kooperation stehen.
...
Bei allen (zunehmenden) staatlichen Eingriffen ist zu beachten, dass trotz des \glqq Goodwills\grqq wie beim CRMA Marktverzerrungen nicht auszuschließen sind; ganz besonders deutlich äußern sich diese Verzerrungen bei Handelsbeschränkungen oder Exportverboten, was für Lieferketten nahezu das Worst-Case-Szenario darstellt. Die Ausbalancierung nationaler Interessen mit globaler Zusammenarbeit bleibt eine bedeutende Herausforderung im Mineraliensektor.

Es wird zudem deutlich, dass durch die Politisierung auch die generelle Konkurrenz im Bereich der Partnerschaften zunimmt -- mit der Gefahr, dass ab einem bestimmten Zeitpunkt schlichtweg keine Partnerschaften mehr \glqq vergeben\grqq werden können, auch da verschiedene Wirtschaftsblöcke miteinander in Konkurrenz stehen.
So haben z. B. hat die EU zwar 2024 ein MoU mit Australien zur Rohstoffpartnerschaft unterzeichnet,\autocite{EMORANDUM OF UNDERSTANDING BETWEEN THE EUROPEAN UNION AND
	AUSTRALIA ON A STRATEGIC PARTNERSHIP ON SUSTAINABLE CRITICAL AND STRATEGIC MINERALS} einen fertigen Deal konnten dann aber 2025 die USA verkünden.\autocite{United States-Australia Framework For Securing of Supply in the Mining and Processing of Critical Minerals and Rare Earths}
	

Die Sicherstellung der Versorgung und damit auch der Transformation hängt somit in erster Linie von den kritischen Mineralien selbst ab -- alle vorgelagerten Schritte und Akteure jedoch in erster Linie von einer effektiven Verwaltung 
...
Generell ist ein Trend hin zu selbstsichereren Auftretens bei rohstoffreichen Staaten im sog. \glqq Globalen Süden\grqq zu beobachten. Einige Staaten verfolgen eine stärker ausgeprägte Form des Ressourcen-Nationalismus, indem sie höhere staatliche Einnahmenanteile sowie eine intensivere Beteiligung an Gemeinschaftsunternehmen einfordern. Andere Länder setzen hingegen darauf, durch die Kontrolle der Weiterverarbeitung von Rohstoffen ihre Position innerhalb der Wertschöpfungskette zu verbessern.
In bestimmten Demokratien wurden vor Wahlen zusätzliche Zugeständnisse von internationalen Bergbauunternehmen verlangt. Darüber hinaus beeinflussen geopolitische Faktoren die Politik: So haben Länder wie Mali, Burkina Faso und Niger ihre Beziehungen zu ehemaligen Kolonialmächten und westlichen Staaten bewusst eingeschränkt.\autocite{https://www.ft.com/content/8d298d6c-ab26-4de5-a159-55f6ad9fdf16?desktop=true&segmentId=d8d3e364-5197-20eb-17cf-2437841d178a#myft:notification:instant-email:content} Auch geraten Bergbau-MNEs zunehemnd in geopolitische Maßnahmen von Ländern, in denen sie Minen betreiben, insbesondere in der Sahelzone  -- und öffnet Staaten, die gute Beziehungen zu diesen Ländern pflegen, neue Möglichkeiten, bestehende Kapazitäten zu übernehmen.\autocite{https://www.ft.com/content/9a0901f1-070f-43e8-9cd3-6bd6ab4f6c4a}

Dies stellt global agierende Firmen vor weitere Herausforderungen hinsichtlich der Wahrung von Standards im internationalen Rohstoffeinkauf.

Zunehmende protektionistische Maßnahmen zum Schutze nationaler Vorkommen tragen zu einer globalen Fragmetierung bei, da da sich die Länder eher auf Selbstversorgung und strategische Allianzen als auf breitere internationale Zusammenarbeit konzentrieren
...
Insbesondere die Eigenschaft der Extraterritorialität bei den amerikanischen und wie folgend dargestellt wird mittlerweile auch bei chinesischen Exportkontrollen ist zu beachten.

Die US‑Exportkontrollordnung (EAR) arbeitet seit Langem mit extraterritorialen Mechanismen – dem de‑minimis‑Regelwerk und den Foreign‑Direct‑Product (FDP) Rules –, die Auslandsgüter mit US‑Technologie‑/Software‑Bezug oder bestimmter US‑Ursprungsanteile unter US‑Jurisdiktion stellen.  Chinas Ankündigung Nr. 61/2025 rekurriert nun funktional auf chinesische Äquivalente: Sie stellt (i) Re‑Exporte chinesischen seltene‑Erden‑Materials, (ii) Auslandsgüter mit ≥ 0,1 \% chinesischem REE‑Wertanteil („de‑minimis“) sowie (iii) Auslandsgüter, die mithilfe chinesischer REE‑Technologie produziert wurden („FDP“) unter MOFCOM‑Lizenz.  Die Parallelität ist in der Praxis ebenso bedeutsam wie rechtspolitisch brisant: Zwei Großmächte projizieren Exportkontrollrechte in globale Liefer- und Fertigungsketten hinein; bei Überschneidungen sind Unternehmen divergierenden Pflichten, Verboten und Gegensanktionsrisiken ausgesetzt.
...
Auch die EU veröffentlichte Ende 2025 Pläne, den Export von CRM-Abfällen zur Sicherung der Versorgung und in Reaktion auf chinesische Exportkontrollen zu beschränken
...
Es ist zu beachten, dass Systemdifferenzen zwischen Europa und China schon immer existierten, jedoch zuletzt das Konfliktpotenzial zunahm und auch das Bewusstsein für chinabezogene Risiken zugenommen hat; insbesondere die chinesischen Weltordnungsvorstellungen weichen hierbei von der deutschen und europäischen Linie der multilateralen und regelbasierten Ordnung ab, sodass sich auch die deutsche Chinapolitik schon vor Einführung der jüngsten Maßnahmen in einem Umbruch befindet.\autocite{Stursberg: Die Handelsbeziehungen mit China(EuZW 2025, 704, 705)}
...
Auch 2008 bzw. 2011 wurden bereits Befürchtungen hinsichtlich der Versorgungssicherheit bei chinesischen Exportverboten\autocite{Top Commodty News 31, S. 1} und der Problematik illegaler chinesischer Verarbeitung\autocite{Top Commodty News 36} geäußert. Dass China sein Quasi-Monopol also durchaus auch politisch einsetzt, ist ebenfalls kein neues Phänomen
...
Die jüngsten chinesischen Maßnahmen im Bereich der Exportkontrollen zeigen eine deutliche Ausweitung der räumlichen Reichweite von Binnenrecht hin zu extraterritorial wirksamen Steuerungsinstrumenten, insbesondere bei kritischen Rohstoffen und seltenen Erden. Mit MOFCOM‑Ankündigung Nr. 46/2024\footnote{https://cset.georgetown.edu/publication/china-rare-earth-export-ban/} wurden Exporte bestimmter Dual‑Use‑Materialien (u. a. Gallium, Germanium, Antimon und „superharte“ Materialien) in die USA „grundsätzlich“ untersagt; zugleich wurden strengere Endverwendungsprüfungen für Grafit eingeführt und eine zivil‑ und ordnungsrechtliche Verantwortlichkeit auch für ausländische Akteure angekündigt, die chinesischen Ursprungswaren entgegen den Verboten an US‑Adressaten weiterreichen. 
...
Im Juni 2024 unterzeichnete Premierminister Li Qiang die Vorschriften zum Management von Seltenen Erden, in denen er das Staatseigentum an Seltenerdressourcen bekräftigte und darauf bestand, dass diese "gemäß den Beschlüssen der Partei" verwaltet werden. China kündigte daraufhin Exportkontrollen für Antimon und verwandte Produkte an und berief sich dabei erneut auf die nationale Sicherheit.\footnote{Catalogue of Goods Subject to Export License Administration; relevant sind die Kategorien 16 bis 26 (u. A. Flussspat, Seltene Erden, Zinn, Wolfram, Molybdän, Antimon und daraus gewonnene Produkte) und Kategorie 32 (Ausgewählte Metalle und Produkte: Wismut, Titan, Wolfram, Platin, Palladium, Ruthenium, Iridium, Osmium, Ferrolegierungen, Nickel, Tantal, Kobalt, Zirkonium, Mangan, Beryllium, Chrom, Germanium, Vanadium, Gallium, Rhenium, Niob).} Ende 2024 verhängte China umfassendere Beschränkungen für Wolfram-, Graphit-, Magnesium- und Aluminiumlegierungen, die für Halbleiter-, Batterie- und Verteidigungsanwendungen von entscheidender Bedeutung sind. m Gegensatz zu den vorherigen Beschränkungen, die ein Ausfuhrgenehmigungssystem vorsahen, kam dies einem vollständigen Verbot gleich, das ausdrücklich auf Ausfuhren in die Vereinigten Staaten abzielte. Der Schritt wurde weithin als Vergeltung gegen die US-Sanktionen im Zusammenhang mit Halbleitern interpretiert.
 ...
 Diese Linie wurde 2025 vertieft: Am 9. Oktober 2025 veröffentlichte MOFCOM eine Serie von Bekanntmachungen (u. a. Nr. 55–58, 61, 62)\footnote{https://cset.georgetown.edu/wp-content/uploads/t0656_china_rare_earth_controls_2025_61_EN.pdf, }, mit denen der gesamte Wertschöpfungsstrang seltenen Erden – von Technologien über Anlagen bis zu Downstream‑Produkten – einer Lizenzpflicht unterworfen wurde. Besonders bedeutsam ist Ankündigung Nr. 61/2025: Erstmals beansprucht China dort extraterritoriale Kontrolle über bestimmte im Ausland hergestellte oder zwischen Drittländern umgesetzte Güter mit chinesischem seltene‑Erden‑Bezug („re‑export“, „de‑minimis“ und „foreign‑direct‑product“-Mechanik).  Parallel wurden Technologien zur Gewinnung und Verarbeitung (Ankündigung Nr. 62/2025) sowie Ausrüstungen und Materialien (Ankündigungen Nr. 55–58/2025) einer Exportkontrolle unterstellt.\footnote{siehe auch https://globaltradealert.org/blog/chinese-export-controls-on-critical-raw-materials-inventory}
...
Hierbei nutzte China die Rohstoffbeschränkungen zudem als Verhandlungsinstrument zur Erreichung von Zugeständnissen seitens der EU im Bereich der Technologieexportbeschränkungen.\autocite{Rohstoffe als Verhandlungswaffe, Handelsblatt} 

Kurzfristige und unvorhergesehene Exportbeschränkungen Chinas bei Seltenen Erden sind auch hier keine Neuigkeit: So wurden chinesische Exporte dieser Mineralien nach Japan im September 2010 kurzfristig eingeschränkt, als Reaktion auf die Festsetzung eines chinesischen Schiffes in japanischen Gewässern. Somit wurden bereits 2010 Exportkontrollen für kritische Minerlaien offensichtlich als Instrument eingesetzt.

Zwar stellten die EU, Japan und auch die USA die Rechtmäßigkeit dieser Beschränkungen bei der WTO 2012 infrage und bekamen 2014 Recht\footnote{DS431}, jedoch waren bzw. sind die entsprechenden Ausiwkrungen schon längst eingetreten.
...
Auch mehrere Monate nach der EInführung blieben Details des Lizensierunngsverfahren unklar, obwohl China noch im Dezember 2025 bestätigte, Exportlizenzen zu vergeben.\autocite{https://www.ft.com/content/ed8e3aa7-810e-4dbc-bdd6-0003f67f73c8?desktop=true&segmentId=d8d3e364-5197-20eb-17cf-2437841d178a#myft:notification:instant-email:content}

Auch gibt es Vermutungen, dass China gerade zur Verhinderung der Etablierung alternativer Lieferketten durch den Westen Exporte von Magneten erlaubt
...
Insbesondere das Vertrauen in die EU hat durch den Vorfall einen Schaden erlitten; die Produtkionsausfälle im Automobilbereich und anderen Branchen verschärften dies.
...
Im Oktober 2025 folgten die nächsten Ankündigungen Exportkontrollen für kritische Rohstoffe sowie zu Verarbeitungstechnologien,\autocite{https://www.jonesday.com/en/insights/2025/10/china-imposes-extraterritorial-export-control-measures-over-rare-earth-items} was sowohl die Gefahr des europäischen Ausschlusses von Lieferketten als auch US-amerikanische Gegenmaßnahmen birgt mit entsprechendem Druck auf die EU und die europäische Industrie somit zum \glqq Kollateralschaden\grqq zwischen dem chinesisch-amerikanischen Handelskonflikt werde.\autocite{Handelsblatt Vela} Zudem erhöhen sich rechtliche Unsicherheiten für Unternehmen hinsichtlich der Einhaltung exportvorgangsrelevanter Vorgänge, da neben den EU- und US-Exportregimen nun auch vermehrt das chinesische System nach Bewertung verlangt und mitunter Widersprüche entstehen.\autocite[siehe hierzu ausführlich]{Neckel: Exportkontrolle im geopolitischen Wettstreit(EuZW 2025, 710, 715)}

Die US‑EAR verankern extraterritoriale Reichweite dogmatisch im „rule‑follows‑the‑part“‑Prinzip und im Schutzprinzip des Völkerrechts; die FDP‑Regeln sind detailliert kodifiziert und durch Verwaltungsleitfäden operationalisiert.  Das chinesische System kombiniert Exportkontrollen mit Gegenmaßnahmengesetzen (AFSL, „Blocking Statute“) und Unreliable‑Entity‑Mechanismen, deren Einsatz häufig politikgesteuert ist und – zumindest bislang – weniger kasuistisch ausformulierte Schwellen und Tests aufweist.  Dadurch entsteht ein hybrider Ansatz aus positiven Kontrollen (Lizenzregime) und negativen Gegenwirkungen (Sanktionen/Blocking), der die Compliance‑Unsicherheit erhöht.

Zwar setzte Peking im November 2025 einen Teil dieser neuen Exportkontrollen temporär aus – als vertrauensbildende Maßnahme nach bilateralen Gesprächen –, die rechtliche Architektur bleibt jedoch bestehen und kann reaktiviert werden.  Die Gesamttendenz ist damit klar: Das chinesische Exportkontrollrecht im Rohstoffbereich gewinnt eine extraterritoriale Dimension, die weit über klassische Ausfuhrgenehmigungspflichten \glqq ab Werk China\grqq hinausgeht und auch ausländische Hersteller sowie Handelsketten mit minimalem chinesischen Inhalts‑ oder Technologiebezug adressiert. Ergänzend ist auf den Ausbau flankierender Gegenmaßnahmeregelungen hinzuweisen: Die 2025 erlassenen Durchführungsbestimmungen zum Anti‑Foreign Sanctions Law (AFSL) konkretisieren Vermögenssperren, Transaktionsverbote und andere Gegenmaßnahmen\autocite{https://www.wilmerhale.com/en/insights/client-alerts/20250331-china-further-formalizes-its-anti-foreign-sanctions-legal-arsenal-the-regulations-on-implementation-of-the-anti-foreign-sanctions-law} und eröffnen private Klagerechte gegen die Umsetzung „diskriminierender ausländischer Maßnahmen“.  Erste Fälle deuten an, dass chinesische Gerichte diese Instrumente zur Abwehr ausländischer Sanktions‑ bzw. Exportrechtswirkungen auf China‑Geschäfte auslegen.

Insgesamt führt diese Entwicklung auch dazu, dass für deutsche (bzw. europäische Unternehmen) eine neue Dimension der Komplexität eröffnet wird, da verschiedene Exportkontrollregime parallel betrachtet und beactet werden müssen und nun erschwerend die ECL-System Chinas hinzutritt, welches analog zum System der USA auch eine extraterritoriale Wirkung entfalten kann und sich dementsprechend Konfliktpotenziale mit Blick auf Definitionen, Auslegungen, Regelungsansprüche und mangelnde Harmonisierung ergeben.\autocite[Insbesondere auch zur Extraterritorialität und der Reichweite der Exportkontrollregime]{EuZW 2025, 710, 711} Hinzu tritt, dass das Risiko sowohl aus formeller Sicht aus auch aus praktischer Sicht Wirkung entfalten kann.\autocite{ibid.}

 Die Maßnahmen sollten Holmium, Erbium, Thulium, Europium und Ytterbium sowie verwandte Materialien betreffen und neue Regeln für die Verwendung chinesischer Seltener Erden im Ausland einführen. Nach Verhandlungen zwischen den USA und China wurden diese Verschärfungen jedoch zunächst ausgesetzt, die Exportbestimmungen aus April 2025 blieben jedoch weiter in Kraft.
...
Infolgedessen rückte die Versorgungslage bei Seltenen Erden aus China insbesondere in der letzten Quartal 2025 in den Fokus der Medien:
...
Es wird deutlich, dass China rohstoffbezogene Maßnahmen zunehmend für Verhandlungen instrumentalisiert, dessen Wirkung durch die Abhängigkeitssituation der europäischen Industrie sichergestellt wird und auch als Reaktion auf europäische Maßnahmen wie die Antisubventionsuntersuchung oder Exportbeschränkungen (ASML)  und auch US-amerikanische Zölle gewertet werden kann. Dies stelle eine neuartige Art des Vorgehens dar: bisher erfolgten chinesische Maßnahmen nicht in der zuletzt gesehenen Breite, nun aber komme es zu einer \glqq Nötigung\grqq \footnote{Ursula von der Leyen, Rede G7 Gipfel Kanada; Rohstoffe als Verhandlungswaffe Handelsblatt 116/2025 S. 16}, und China werden durch China als geopolitisches Instrument wie ein \glqq Wasserhahn\grqq eingesetzt, der \glqq je nach politischer Wetterlage geöffnet oder zugedreht\grqq werden könnte und ebenfalls die strukturelle Neuausrichtung der internationalen Wirtschaftsordnung repräsentiert.\autocite{Neckel: Exportkontrolle im geopolitischen Wettstreit(EuZW 2025, 710, 715)}

Darüber hinaus gewinnen die chinesischen Exportkontrollen, ähnlich wie die der USA, eine Außendimension
...
Aus rohstoffverwaltungsrechtlicher Sicht ist die chinesische Extraterritorialisierung Ausdruck eines strategischen Ressourcen‑Steuerungsrechts: Sie koppelt den Zugang zu upstream‑ (Gewinnung/Metallurgie) und midstream‑Kapazitäten (Trenn- und Magnettechnologien) an genehmigungsrechtliche Kontrolle, und verlängert diese Kontrolle über Wertschöpfungsketten hinweg bis in ausländische Verarbeitungs‑ und Veredelungsstufen.  Faktisch entsteht damit ein „Kettenlizenz“-Regime, das den chinesischen Regulierungszugriff entlang des Rohstofflebenszyklus institutionalisiert – einschließlich Know‑how‑Transfers (Technologieexporte), Ausrüstungen und Mischungen/Komponenten. Rechtlich lässt sich diese Entwicklung als Außenwirkung verwaltungsrechtlicher Steuerungsnormen charakterisieren, die an Rohstoffbezüge (Herkunft, Technologiegenese, Inhaltsanteile) anknüpfen und dadurch einen belastbaren Zuständigkeitsnexus behaupten. Die chinesische Praxis bezieht sich dabei auf die Export Control Law‑Grundlagen und die Regulations on Export Control of Dual‑Use Items; Ankündigung Nr. 61/2025 wird explizit als erstmalige Ausübung extraterritorialer Jurisdiktion beschrieben.  Ökonomisch wirkt das als Preissetzungs‑ und Verfügbarkeitsmacht über globale Lieferketten (Magnete, Anodenmaterialien, Superhard‑Materialien), mit unmittelbaren Effekten auf europäische Automobilindustrie.

Es ist davon auszugehen, dass China seine Exportkontrollen im Rahmen des geopolitischen Wettbewerbs fortführen wird, und es zudem nicht im Interesse Chinas ist, seine Marktanteile im strategischen Markt der Rohstoffe aufzugeben.

Kurzfristig ist – trotz der einjährigen „Pause“ – von situationsabhängiger Reaktivierung und Feinjustierung auszugehen (z. B. Listenanpassungen, Schwellenwerte, Ausweitung auf weitere CRMs oder Prozessschritte).  Denkbar sind (i) präzisere De‑minimis‑/FDP‑Kriterien und Ausweitung auf weitere Downstream‑Produkte (etwa Legierungen, Katalysatoren), (ii) verstärkte Durchsetzung gegen Transshipment und „Substantial Assistance“ in Auslandsketten, sowie (iii) Verschränkung mit Daten‑ und Cyberrecht (z. B. Melde‑ und Datenexportregime für rohstoffbezogene technische Daten/Parameter).  Mittel‑ bis langfristig ist ein institutionalisiertes Gegengewicht zu US‑EAR wahrscheinlich – mit wechselseitigen Anpassungszyklen („tit‑for‑tat“) entlang kritischer Technologiesektoren.
...
Mittlerweile habe auch auf europäischer Ebene ein Umdenken hinsichtlich der Nutzung von Exportkontrollen als industrie- und geopolitisches Verhandlungsinstrument begonnen, wie die uropean Economic Security Strategy 2023, das Weißbuch zur Exportkontrolle 2024 und die Abgrenzung des Begriffes der Wirtschaftssicherheit zeigen -- dies ist jedoch nur ein initialer Ansatz
...
Der bergbauliche Bereich befindet sich im Dilemma zwischen Nachfrage und Klimaschutz, denn zur Erreichung von Klimazielen, Net Zero, Green Deal etc. und dem Umsteig auf emissionsfreie Mobilität sind mehr kritische Rohstoffe erforderlich, die jedoch aus dem aktuellen Bestand nicht gedeckt werden können und daher eine Ausweitung der Gewinnung unausweichlich machen; trotz Recycling oder neuer Technologien (z.B. im Bereich der EV-Batterietechnik) wird es jedoch weiterhin genügend Bedarf auch aus anderen Anwenungsfällen geben.
...
Darüber hinaus zeigt das Kapitel deutlich, dass rohstoffbezogene Maßnahmen nur schwerlich einzelnen Politikbereichen zuzuordnen sind und die Grenzen einzelner, mitunter auch grundlegend verschiedener Politikbereiche zunehmend durchlässig werden und miteinander verschwimmen. Auch ein mögliches Auseinanderdriften zwischen institutioneller Policygovernance und realismusgetriebener und vorpreschender Exploration sollte bedacht werden
...
Rohstoffe sind mittlerweile ein zentrales Instrument von Geopolitik, mit entsprechenden Auswirkungen auf Unternehmen die unmittelbar von Lieferkettenproblematiken betorffen sind, aber auch solchen die indirekt von der Wertschöpfung dieser Sektoren profitieren.

Es wird deutlich, dass die Governance-Rolle im Bereich der kritischen Mineralien und Rohstoffe im Allgemeinen zugenommen hat und mittlerweile das akzelerierende Moment darstellt: Ohne die Gestaltung eines entsprechenden Rohstoffrechtsrahmens, der seine Durchsetzbarkeit auch über die Grenzen der Union hinweg entfaltet, eine eindeutig geregelte Verteilung von Last und Nutzen sowie eine nachvollziehbare Kontrolle sowie strategisch deutliche Ausrichtungen tragen dazu bei, dass sich die Risikowahrnehmung hin zu einer Chancenwahrnehmung verschieben kann und etwaige Risiken nicht mehr als signifikanter wahrgenommen werden als die daraus resultierenden Vorteile.

Die Frage nach einer Rohstoffverwaltung betrifft daher nicht das Ob, sondern das Wie -- d.h., wie können die zahlrichen und diamteral liegenden Interssen so vereinbart werden, dass transparente und eindeutige, gleichzeitig aber auch schützende jedoch nicht überregulierende Maßnahmen faire Rahmenbedingungen für alle Stakeholder schaffen?

Die Erwartungshaltung an Standards dürfte, zumindest im europäischen Bereich, auch über verschiedene Initiativen und unternehmensinterne Richtlininen dieselbe sein und daher eine Einigung auf bestimmte Qualitätskriterien und Standards als weniger hinderlich einzustufen ist, insbesondere wenn der Prozess transparent und nachvollziehbar gestaltet wird. Daher scheint zumindest eine Weiterentwicklung bestehender Standards ratsam und im nächsten Schritt der Aufbau einen umspannenden Rahmens.

Vor diesem Hintergrund stellt sich auch die Frage nach der Zertifizierung bzw. Auditierung solcher Standards, insbesondere hinsichtlich der durchführenden Stellen und der Anerkennung von Zertifizierung zwischen den Mitgliedsstaaten.
